...
console.log("Policy: cheapest/static/environment checks first; expensive browser/build checks last.");
...
for (const [name, command, args] of checks) {
  ...
  if (result.status !== 0) {
    ...
    console.error("STOP: fix this failure before browser installation, E2E, or production build.");
