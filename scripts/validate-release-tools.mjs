...
if (imports.length !== publicTools.length) errors.push(`Public runtime count (${imports.length}) does not match manifest count (${publicTools.length}).`);
...
const report = {
  ...
  requiredEvidence: ["runtime", "dynamic-route", "content", "seo", "desktop-e2e", "repeatability", "build", "production-audit"],
