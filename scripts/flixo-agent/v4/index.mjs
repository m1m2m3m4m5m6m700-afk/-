...
import { executePlan, validateV3PlanForExecution } from './experimental/execute-plan.mjs';
...
export function planExperiments(roots, options = {}) {
  ...
  return { version: '4.0.0', role: 'EXECUTE', mode: 'experimental-dry-run', hypotheses, verification, autoApply: false, requiresCIProof: true };
}

export { executePlan, validateV3PlanForExecution };
