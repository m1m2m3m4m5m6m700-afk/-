...
const localized404 = (locale: string): string => {
  ...
  return `<!doctype html><html lang="${locale}" dir="${dir}"><head><meta charset="utf-8"><meta name="robots" content="noindex,nofollow"><meta name="content-language" content="${locale}"><meta name="viewport" content="width=device-width, initial-scale=1"><title>404 | FLIXO</title></head><body><main><h1>404</h1><p>Tool not found.</p></main></body></html>`;
};
