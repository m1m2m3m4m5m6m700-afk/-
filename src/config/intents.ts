...
export const INTENT_SLUGS_REGISTRY: readonly IntentSEOConfig[] = Object.freeze([
  ...
  { slug: 'compress-id-photo-100kb', workflowId: 'web-ready', title: 'Compress an ID Photo for a Small File Size', description: 'Prepare an ID-style image for upload with a lighter web-ready file and predictable local processing where supported.', keywords: ['compress id photo', 'id photo under 100kb', 'reduce id image size', 'small image upload'], preset: { targetSizeKB: '100' }, outcome: 'A smaller image suitable for upload limits.' },
