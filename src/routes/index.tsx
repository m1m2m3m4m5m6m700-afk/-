...
import { ArrowUpRight, Check, Image, LayoutGrid, Lock, Search, ShieldCheck, Sparkles, Wand2, Zap } from 'lucide-react';
        ...
        <div className="home-container home-modern">
          <section className="home-hero" aria-labelledby="home-title">
            ...
            <div className="home-hero-card">
              ...
              <div className="home-hero-card-top"><span className="home-card-badge"><Sparkles size={14} /> QuickFlow</span><span className="home-card-muted">No maze</span></div>
              <div className="home-hero-card-content">
                <div className="home-hero-icon"><Wand2 size={30} /></div>
                <p className="home-hero-card-title">One goal. One clear path.</p>
                <p className="home-hero-card-copy">FLIXO hides the tool chain and keeps the user focused on the finished result.</p>
                <div className="home-hero-mini-flow"><span><b>1</b> Intent</span><span><b>2</b> Plan</span><span><b>3</b> Result</span></div>
                <Link to="/en/ai-image-generator" className="primary-button home-hero-button">Explore AI <ArrowUpRight size={17} /></Link>
              </div>
            </div>
          </section>

          <section className="home-competitive-proof" aria-label="FLIXO competitive advantages">
            <div><Zap size={18} /><strong>Fast path</strong><span>Start from the result, not the editor.</span></div>
            <div><Lock size={18} /><strong>Local-first</strong><span>Browser processing where supported.</span></div>
            <div><ShieldCheck size={18} /><strong>No account required</strong><span>Use the tools before creating an account.</span></div>
            <div><RotateRepeatIcon /><strong>Repeat</strong><span>Run the same workflow again with less setup.</span></div>
          </section>
