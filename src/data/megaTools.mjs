const PRESETS = [
  ["quick", "Quick"], ["small", "Small"], ["medium", "Medium"], ["large", "Large"],
  ["social", "Social"], ["web", "Web"], ["mobile", "Mobile"], ["print", "Print"],
  ["hd", "HD"], ["pro", "Pro"], ["max", "Max"],
];
...
const BASES = {
  images: [
    ...
    ["rotate", "Rotate", "Rotate the image."],
  ...
  video: [
    ...
    ["poster", "Extract Poster", "Capture a representative poster frame."],
    ...
    ["resize", "Resize", "Render a resized preview from the video."],
    ["rotate", "Rotate", "Render a rotated preview frame."],
    ["flip", "Flip", "Render a mirrored preview frame."],
    ["mute", "Mute Preview", "Create a muted browser preview."],
    ["speed", "Speed Preview", "Preview the video at a different playback rate."],
    ["contact-sheet", "Contact Sheet", "Create a contact sheet of representative frames."],
    ["aspect", "Aspect Preview", "Create a preview using a target aspect ratio."],
  ],
  audio: [
    ["inspect", "Inspect", "Read duration, sample rate and channel metadata."],
    ["waveform", "Waveform", "Generate a waveform preview."],
    ["peak", "Peak Level", "Measure the peak signal level."],
    ["rms", "RMS Level", "Measure average signal energy."],
    ["normalize", "Normalize", "Normalize audio to a target peak."],
    ["trim", "Trim", "Trim the audio buffer."],
    ["fade-in", "Fade In", "Apply a fade-in to the buffer."],
    ["fade-out", "Fade Out", "Apply a fade-out to the buffer."],
    ["mono", "Mono", "Downmix audio to mono."],
    ["reverse", "Reverse", "Reverse the audio buffer."],
    ["speed", "Resample", "Create a resampled-speed variant."],
    ["wav", "Export WAV", "Export decoded audio to WAV."],
  ],
  pdf: [
    ["inspect", "Inspect", "Report pages, dimensions and metadata."],
    ["extract-text", "Extract Text", "Extract searchable text from PDF pages."],
    ["rotate", "Rotate Pages", "Rotate pages by a controlled angle."],
    ["page-numbers", "Page Numbers", "Add page numbers to the document."],
    ["watermark", "Watermark", "Add a text watermark to pages."],
    ["remove-metadata", "Remove Metadata", "Remove common document metadata."],
    ["duplicate", "Duplicate Pages", "Duplicate selected pages."],
    ["extract-range", "Extract Range", "Extract a selected page range."],
    ["split-even", "Split Even", "Split the document into even page groups."],
    ["blank-cover", "Blank Cover", "Prepend a blank cover page."],
    ["flatten", "Flatten", "Flatten PDF form fields where possible."],
    ["poster", "Page Poster", "Render a page as an image preview."],
  ],
};
...
export const MEGA_TOOLS = Object.freeze(
  Object.entries(BASES).flatMap(([category, bases]) =>
    bases.flatMap(([handler, name, description]) =>
