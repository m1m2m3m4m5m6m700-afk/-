...
const LOCALE_LOADERS: Record<Exclude<LocaleCode, "en">, () => Promise<{ default?: Dictionary } & Partial<Dictionary>>> = {
  ar: () => import("./locales/ar"), es: () => import("./locales/es"), fr: () => import("./locales/fr"), de: () => import("./locales/de"), pt: () => import("./locales/pt"), it: () => import("./locales/it"), nl: () => import("./locales/nl"), sv: () => import("./locales/sv"), pl: () => import("./locales/pl"), tr: () => import("./locales/tr"), ro: () => import("./locales/ro"), cs: () => import("./locales/cs"), uk: () => import("./locales/uk"), el: () => import("./locales/el"), he: () => import("./locales/he"), fa: () => import("./locales/fa"), ru: () => import("./locales/ru"), ms: () => import("./locales/ms"), "zh-CN": () => import("./locales/zh-CN"), ja: () => import("./locales/ja"), ko: () => import("./locales/ko"), hi: () => import("./locales/hi"), bn: () => import("./locales/bn"), th: () => import("./locales/th"), vi: () => import("./locales/vi"), id: () => import("./locales/id"),
};
...
function loadedDictionary(module: Partial<Dictionary> & { default?: Dictionary }): Dictionary { return (module.default ?? module) as Dictionary; }
