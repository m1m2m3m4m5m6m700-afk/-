...
export const en = {
  ...
  "hero.promo.body":
    "Try the Image Enhancer today — upscale, sharpen, and adjust your photos in your browser.",
  ...
  "tool.image-enhancer.name": "Image Enhancer",
  "tool.image-enhancer.tagline":
    "Upscale images up to 8x and adjust sharpness, brightness, contrast, vibrance, and tone.",
  ...
  "why.privacy.body":
    "Image, PDF, and utility tools run entirely in your browser. The AI Translator sends your text to Flixo's server for generation but does not store it after use.",
  ...
  "faq.a2":
    "You paste text, pick a source and target language (or let auto detect do it), and Flixo returns the translation. The translator uses Flixo's server-side AI provider, so input is sent to the server for generation.",
  "faq.q3": "Do you store what I type?",
  "faq.a3":
    "For in-browser tools (images, PDFs, utilities) your input stays in your tab. For the AI Translator, your text is sent to the server for generation but is not stored after the response is returned.",
  ...
  // Image Enhancer UI
  "imageEnhancer.preset.auto": "Auto",
  "imageEnhancer.preset.autoDesc":
    "Balanced upscale with noise-aware sharpening and color adjustment",
  "imageEnhancer.preset.portrait": "Portrait",
  "imageEnhancer.preset.portraitDesc": "Warm skin-tone boost and balanced contrast for portraits",
  "imageEnhancer.preset.restore": "Faded Photo",
  "imageEnhancer.preset.restoreDesc": "Recover contrast in faded or sepia-toned photos",
  "imageEnhancer.preset.deblur": "De-blur & Sharpen",
  "imageEnhancer.preset.deblurDesc": "Apply unsharp masking to crisp edges and detail",
  "imageEnhancer.preset.ultra": "Ultra 8x Upscale",
  "imageEnhancer.preset.ultraDesc":
    "Maximum 8x resolution scaling for high-detail graphics & prints",
  "imageEnhancer.progressDetail": "Applying sharpening, tone & contrast adjustments…",
  ...
  "imageEnhancer.face": "Skin Tone Boost",
  "imageEnhancer.restore": "Faded Photo Tone",
  "imageEnhancer.blur": "Blur Reduction",
  "imageEnhancer.face.hint": "Warm skin-tone color adjustment",
  "imageEnhancer.restore.hint": "Recover contrast in faded photos",
  ...
  "imageEnhancer.stats.superRes": "{scale}x Upscale",
  ...
  "imageEnhancer.presets": "Presets",
  "imageEnhancer.scale": "Upscale Scale",
